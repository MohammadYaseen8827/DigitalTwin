...
export async function getRunToFailureHistory(machineId: string): Promise<any[]> {
  return axiosClient.get(`/RunToFailure/${machineId}/results`)
}

// Export service object for convenience
export const runToFailureService = {
  runToFailureSimulation,
  runToFailureSimulationAlt,
  generateTrajectories,
  generateTrajectoriesAlt,
  getRunToFailureResults,
  getRunToFailureResultsAlt,
  getRunToFailureHistory
}

export default runToFailureService
