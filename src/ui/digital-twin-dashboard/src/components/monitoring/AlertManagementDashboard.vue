...
const alerts = ref<any[]>([
  ...
  },
  {
    ...
    message: 'Critical bearing vibration detected',
    severity: 'Critical',
...
const filteredAlerts = computed(() => {
  ...
  if (statusFilter.value !== 'all') {
    ...
    filtered = filtered.filter(alert => alert.isAcknowledged === isAcknowledged)
  }
...
const loadAlerts = async () => {
  try {
    loading.value = true
    // In a real implementation, this would fetch from the alerts service
