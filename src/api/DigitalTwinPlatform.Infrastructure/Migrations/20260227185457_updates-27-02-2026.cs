...
{
    /// <inheritdoc />
    public partial class updates27022026 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConnectionUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityTypes = table.Column<List<string>>(type: "text[]", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Metrics = table.Column<Dictionary<string, double>>(type: "jsonb", nullable: false),
                    Events = table.Column<List<SimulationEvent>>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "SyntheticDataGenerations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MachineType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    NumberOfTrajectories = table.Column<int>(type: "integer", nullable: false),
                    TimeRange = table.Column<TimeSpan>(type: "interval", nullable: true),
                    RandomSeed = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
                    GeneratedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CompletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Statistics = table.Column<GenerationStatistics>(type: "jsonb", nullable: false),
                    ValidationReport = table.Column<DataValidationReport>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SyntheticDataGenerations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataSynchronizations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DataSynchronizations_ExternalSystems_ExternalSystemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemIntegrations_ExternalSystems_ExternalSystemId",
                        column: x => x.ExternalSystemId,
                        principalTable: "ExternalSystems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "SyntheticDataPoint",
                columns: table => new
                {
                    SyntheticDataGenerationId = table.Column<Guid>(type: "uuid", nullable: false),
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Timestamp = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SyntheticDataPoint", x => new { x.SyntheticDataGenerationId, x.Id });
                    table.ForeignKey(
                        name: "FK_SyntheticDataPoint_SyntheticDataGenerations_SyntheticDataGe~",
                        column: x => x.SyntheticDataGenerationId,
                        principalTable: "SyntheticDataGenerations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TenantUsers_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuggestedActions = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataSynchronizations_ExternalSystemId",
                table: "DataSynchronizations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemIntegrations_ExternalSystemId",
